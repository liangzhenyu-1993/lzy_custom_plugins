        ...
        CoustomTip: function (cfg) {
            ...
            var CTip = function (cfg) {
                ...
                document.onkeydown = function (event) {
                    ...
                    if (e && e.keyCode === 27) _this.closeTip();
                };
            ...
            CTip.prototype = {
                ...
                showTip: function (content) {
                    ...
                    if (this.defCfg.blurredBg) {
                        $body.append(bgObj.css({
                            top: parentRect.top,
                            left: parentRect.left,
                            width: parentRect.width,
                            height: parentRect.height
                        }));
                        bgObj.on("mousewheel DOMMouseScroll", function () {
                            return false;//在弹框背景显示是滚轮事件无效
                        });
                        this.bgObjs.push(bgObj);
                    }
                    ...
                    if (this.defCfg.autoHide) {
                        setTimeout(function () {
                            tipObj.fadeOut(_this.defCfg.hideTime, function () {
                                _this.closeTip(tipObj, bgObj);
                            });
                        }, _this.defCfg.showTime);
                    }
                    setTimeout(function () {
                        _this.closeTip();
                    }, 60000);
                ...
                closeTip: function (tipObj, bgObj) {
                    ...
                    if (tipObj) {
                        ...
                        for (var i = this.bgObjs.length - 1; i >= 0; i--) delObj(this.bgObjs[i], this.bgObjs);
                    }
                    if (bgObj) delObj(bgObj, this.bgObjs);
                }
            };


            // var cTip = {
            //     bgDom: "<div style='position: fixed;z-index:11110;'></div>",
            //     imgDom: "<div style='width: 25px;height: 25px;border: none;display: inline-block;background-size: 100% 100%;margin-bottom: -5px;'></div>",
            //     tipDom: "<div style='position: fixed;height:auto;z-index:11111;text-align: center;'></div>",
            //     defCfg: {},
            //     bgObjs: [],
            //     tipObjs: [],
            //     init: function (cfg) {
